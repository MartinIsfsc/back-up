...
<html lang="en">
  ...
  <body>
    ...
    <header>
      ...
      <a href="index.php" id="menu_logo"><img src="http://the-layers-project.test/wp-content/uploads/2018/12/tlp_blanc-1.png" alt="THE LAYERS PROJECT" id="menu_logo_link"></a>
